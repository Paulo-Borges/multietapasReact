...
const SelectPage = () => {
  ...
  return (
    <div className=" w-[375px] h-[657px] bg-wite  min-[1440px]:w-[1000px] min-[1440px]:h-[590px] min-[1440px]:p-2 min-[1440px]:rounded-md">
      <div className=" w-[375px] h-[590px] relative bg-pink-50 min-[1440px]:bg-transparent ">
        ...
        <form className="flex flex-col bg-white w-[335px] m-auto absolute left-5 min-[1440px]:left-90 top-26 min-[1440px]:top-6 p-6 items-start rounded-2xl">
